...
public class DeskCapt extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        checkAudios = new javax.swing.JCheckBox();
        ...
        buttonGetLessonMaterials.setText("Get Materials");
        ...
        buttonHeaderBack.setText("<");
        buttonHeaderBack.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonHeaderBackActionPerformed(evt);
            }
        });

        buttonItemsBack.setText("<");
        buttonItemsBack.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonItemsBackActionPerformed(evt);
            }
        });
    ...
    private void actGetLessonMaterials() {
        estrategia.getLessonMaterials((int) editHeader.getValue(), fieldTitle.isSelected());
    }
    ...
    private void actMakeDownloads() {
        estrategia.makeDownloads((int) editHeader.getValue(), checkAudios.isSelected());
    }
    ...
    private void buttonRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRestartActionPerformed
        editHeader.setValue(-1);
        editItem.setValue(-1);
    }//GEN-LAST:event_buttonRestartActionPerformed

    private void buttonHeaderBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHeaderBackActionPerformed
        editHeader.setValue(-1);
    }//GEN-LAST:event_buttonHeaderBackActionPerformed
    ...
    private javax.swing.JButton buttonItemsBack;
    ...
    private javax.swing.JCheckBox checkAudios;
    ...
    private javax.swing.JCheckBox fieldTitle;
